...
exports.ModificationsModule = ModificationsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: modification_request_schema_1.ModificationRequest.name, schema: modification_request_schema_1.ModificationRequestSchema },
            ]),
